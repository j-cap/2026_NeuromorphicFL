...
The reproduced numerical tables are stored under
\path{experiments/results/12a_logistic_regression/reproduction_strong.csv}
and \path{reproduction_heterogeneity.csv}.
