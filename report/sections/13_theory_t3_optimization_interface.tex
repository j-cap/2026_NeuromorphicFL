...
The instrumentation consumes no random numbers.  A paired smoke test ran the
same synthetic federation and seed with the audit disabled and enabled; every
pre-existing scalar output, including objective, accuracy, message count, and
coordinate-event count, agreed.  The maximum numerical errors in
\eqref{eq:t3-audit-net-alignment} and in reconstructing $q_rC^r$ were
$2.70\times10^{-6}$ and $5.90\times10^{-9}$, respectively.
...
$2600$ & $83.24\%$ & $34.40$ & $100.00\%$ & $30.73\%$ & $74.19\%$ & $15.72\%$\\
$2700$ & $83.28\%$ & $32.28$ & $100.00\%$ & $32.30\%$ & $74.19\%$ & $15.31\%$\\
\midrule
Mean & $83.11\%$ & $33.41$ & $98.92\%$ & $31.52\%$ & $75.27\%$ & $15.47\%$\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    $D_r-H_r$ is positive on $92$ of $93$ audited updates.  The cross-seed
    weighted ratio is $33.41\pm1.07$, and only seed $2500$ has a negative
    audited update, at round $85$.
    \item \emph{The margin weakens late in training.}  The mean alignment ratio
    falls from $44.38$ in rounds $1$--$50$ to $25.29$ in rounds $101$--$150$;
    the harmful share rises from $29.51\%$ to $39.05\%$.  Thus the finite-run
    ...
    the $92$ positive-alignment updates, $22$ still increase the reference
    ...
    aggregate energy.  Signed client cancellation removes $15.47\%$ of the
    event-stream $\ell_1$ mass on average.
\end{enumerate}

As a scale diagnostic, a fixed $\kappa=8$ is violated on only $1$--$2$ of the
$31$ audited rounds per seed, but the resulting weighted positive-part defect
still equals $10.6\%$--$13.0\%$ of the corresponding target alignment budget.
...
The audit is deliberately limited to three paths, a $5000$-sample reference
gradient, and every fifth round.  It therefore provides evidence for the
