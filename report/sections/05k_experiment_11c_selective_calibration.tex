...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{Must every calibration refresh all }d\text{ gradient coordinates, or can only the uncertain components be refreshed?}}$}
\end{center}
...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\textbf{refreshing a small uncertain subset more often can be better than refreshing the whole gradient less often.}}$}
\end{center}
...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{selective calibration works, but trustworthy magnitude refresh still dominates total communication.}}$}
\end{center}
...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\textbf{certificate maintenance should be sparse and uncertainty driven: frequent partial refresh is more efficient than infrequent dense refresh, but the next scaling problem is to replace coordinate-wise float calibration by structured block or low-dimensional information.}}$}
\end{center}
