...
The fraction of parameters that fire at least once is approximately $65.1\%$. This is lower than in Experiment~13B and is mainly caused by the large first-layer matrix. Table~\ref{tab:exp14a-tensor-activity} resolves the activity by tensor.
\begin{table}[ht]
\centering
\small
