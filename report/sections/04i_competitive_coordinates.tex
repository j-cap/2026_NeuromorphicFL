...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{Does competition among accumulated coordinate evidences allocate a sparse communication budget better than independent firing or conventional Top-$K$ selection?}}$}
\end{center}
