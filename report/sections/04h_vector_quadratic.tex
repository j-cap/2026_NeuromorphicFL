...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{Can sparse LIF-style coordinate events remain useful once optimization and communication are genuinely vector-valued?}}$}
\end{center}
