...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{Can occasional dense calibration messages support a much larger stream of safe low-bit coordinate events?}}$}
\end{center}
...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\textbf{occasional trustworthy magnitude information can make descent-aware sparse events practical, but calibration payload and representation geometry are now the dominant design problems.}}$}
\end{center}
