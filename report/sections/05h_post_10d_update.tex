...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{construct a communication-efficient conservative estimate of global event alignment and uncertainty.}}$}
\end{center}
...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{11\mathrm{B}\;\text{certificate}\;\rightarrow\;12\;\text{logistic regression}\;\rightarrow\;\text{basis/block refinement as required}.}$}
\end{center}
