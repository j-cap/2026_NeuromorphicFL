...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{Does coordinate-level inter-event timing contain useful optimization information beyond event sign?}}$}
\end{center}
and, more importantly,
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{Can that information be decoded into a better jump rule than fixed $q$ or conventional global jump decay?}}$}
\end{center}
