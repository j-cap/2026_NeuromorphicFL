...
Theory tasks T1--T4 now provide the scoped characterization of the frozen lossy stateful compressor. The current publication path is therefore evidence and novelty closure, one independent breadth benchmark, and concise manuscript extraction rather than another open-ended mechanism search.
