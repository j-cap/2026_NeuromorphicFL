...
than four independent worst-case bounds.  Empirically, the smallest decisive
next experiment is a controlled $2\times2$ decomposition over IID versus
strong non-IID partitions and $E=1$ versus $E=5$.  That experiment can test
whether $B_r$ responds to data heterogeneity and whether $L_r$ responds to
local-update depth before a formal covariance assumption is introduced.
