...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{Does Top-$K$ selection of temporally accumulated membrane evidence allocate bits better than Top-$K$ selection of conventional updates?}}$}
\end{center}
