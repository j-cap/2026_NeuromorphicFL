...
\begin{equation}
  \boxed{\text{Can the amplitude of a sparse signed event be selected from a descent condition rather than a fixed or heuristic schedule?}}
\end{equation}
...
\begin{equation}
  \boxed{\text{event-derived/certified descent sizing approaches oracle behavior with no floating-point magnitude payload}.}
\end{equation}
