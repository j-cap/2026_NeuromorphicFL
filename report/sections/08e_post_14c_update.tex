...
\begin{aligned}
\text{quadratics}
&\rightarrow \text{convex logistic regression}
\rightarrow \text{synthetic MLPs}\\
&\rightarrow \text{deep MLPs}
\rightarrow \text{binary Fashion-MNIST}
\rightarrow \text{ten-class Fashion-MNIST}.
\end{aligned}
\end{equation}
