...
\path{src/neuromorphicfl/fmnist_multiclass_benchmark.py}. The Experiment~14B
audit, refinement, fairness, final robustness, and layer-diagnostic drivers
match \path{experiments/14b_*.py}. Report-ready observed tables are stored under
\path{experiments/results/14b_fmnist_multiclass/}.
