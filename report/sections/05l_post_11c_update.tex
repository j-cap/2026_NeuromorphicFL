...
\begin{equation}
  \boxed{\text{normalized coordinate LIF} + \text{descent certificate} + \text{selective uncertainty-driven calibration}.}
\end{equation}
...
\begin{equation}
  \boxed{\text{in which communication basis can both sparse events and sparse certificate maintenance remain informative?}}
\end{equation}
