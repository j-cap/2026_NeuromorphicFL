...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{12\mathrm{A}\;\text{logistic regression + practical certificate}\;\rightarrow\;12\mathrm{B}\;\text{representation/block refinement if needed}\;\rightarrow\;13\;\text{small neural network}.}$}
\end{center}
