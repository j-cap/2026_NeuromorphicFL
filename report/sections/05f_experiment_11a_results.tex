...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\text{a sufficiently informative local--global disagreement bound can convert local evidence into globally safe sparse events.}}$}
\end{center}
...
\begin{center}
\resizebox{0.96\linewidth}{!}{$\displaystyle \boxed{\textbf{descent-aware neuromorphic event sizing is promising; the research bottleneck is a sparse federated certificate of global alignment and uncertainty.}}$}
\end{center}
