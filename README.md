...
matched-baseline campaign and theory tasks T1--T4 are complete. The current
priority is manuscript extraction plus one reviewer-facing breadth experiment,
