...
| C9 | The communication--performance result transfers from Fashion-MNIST to CIFAR-10 with a compact conventional CNN, including against a development-tuned dense server gain. | `paper/ijcnn2027/evidence/cifar10_master_results.csv`, generated from the frozen P3 Event result and P8 tuned dense row; protocol and interpretation in `P3_PROTOCOL.md`, `P3_DECISION.md`, and `P8_REVISION_AUDIT.md` | Main frontier figure and result table | Ready; three held-out seeds support the tested operating-point claim, not statistical significance or broad dataset generalization. |
