...
def products(
    ...
    return {
        ...
        QUALITY_TEX: latex_table(
            ...
            caption=(
                "Fashion-MNIST quality-selected comparison over ten matched "
                "seed pairs. Values are mean $\\pm$ sample standard deviation. "
        ...
        TRAFFIC_TEX: latex_table(
            ...
            caption=(
                "Fashion-MNIST nearest-traffic comparison over the same ten "
                "matched seed pairs."
            ),
...
def cifar_latex_table(rows: list[dict[str, str]]) -> str:
    lines = [
        ...
        "\\begin{table*}[t]",
        "\\centering",
        "\\caption{CIFAR-10 results over ten matched seed pairs. Values are mean "
